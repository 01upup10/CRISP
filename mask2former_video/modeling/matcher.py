...
class VideoHungarianMatcher(nn.Module):
    ...
    #     self.batch_dice_loss_jit = torch.jit.script(
    #     self.batch_dice_loss
    # )  # type: torch.jit.ScriptModule
    #     self.batch_sigmoid_ce_loss_jit = torch.jit.script(
    #     self.batch_sigmoid_ce_loss
    # )  # type: torch.jit.ScriptModule
    ...
    def memory_efficient_forward(self, outputs, targets):
        ...
        for b in range(bs):
            ...
            with autocast(device_type='cuda',enabled=False):
                ...
                # cost_dice = batch_dice_loss_jit(out_mask, tgt_mask) # error:Global alloc not supported yet
