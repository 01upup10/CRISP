...
cfg_file=configs/youtubevis_2019/video_maskformer2_R50_bs16_8ep.yaml
base=results/exp
step_args="CONT.BASE_CLS 20 CONT.INC_CLS 4 CONT.MODE overlap SEED 42"
task=ytvis
task_name=ytvis-task4 # continual setting
name=MxF
...
cont_weight="${base}/ytvis_2019-vis_20-4-ov/${exp_name}/step0/model_final.pth"
